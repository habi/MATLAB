...
PhysicalPixelSizeCamera = 6.5; %um
pixelsize = PhysicalPixelSizeCamera / Magnification * Binning; % makes Pixel Size [um] equal to second table on TOMCAT website (http://is.gd/citz)

FOV_px = round( FOV_mm * 1000 / pixelsize); % mm -> um -> px
CameraWidth = 2560;
DetectorWidth_px= CameraWidth / Binning;  % The camera is 2048 px wide > FOV scales with binning

disp (['Camerawidth is set to ' num2str(CameraWidth)])
disp (['Camerapixelsize is set to ' num2str(PhysicalPixelSizeCamera)])
